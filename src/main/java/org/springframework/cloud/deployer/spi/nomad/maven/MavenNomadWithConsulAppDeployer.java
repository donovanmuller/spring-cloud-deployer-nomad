...
/**
 * Deployer responsible for deploying {@link MavenResource} based applications using the Nomad
 * <a href="https://www.nomadproject.io/docs/drivers/java.html">Java</a> driver. Consul is available
 * and will be used to create a Service for discovery. See
 ...
 */
public class MavenNomadWithConsulAppDeployer extends MavenNomadAppDeployer {

	private static final Logger logger = LoggerFactory.getLogger(MavenNomadWithConsulAppDeployer.class);

	private NomadClient client;
	private ConsulClient consul;
	private NomadDeployerProperties deployerProperties;

	public MavenNomadWithConsulAppDeployer(NomadClient client, ConsulClient consul,
